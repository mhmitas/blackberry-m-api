...
const staticTools = [getWeather, getCoolestCities];
const toolNode = new ToolNode(staticTools);

const modelWithTools = new ChatMistralAI({
  model: "mistral-medium-latest",
  temperature: 0,
}).bindTools(staticTools);
...
const toolNodeForGraph = new ToolNode(staticTools);
